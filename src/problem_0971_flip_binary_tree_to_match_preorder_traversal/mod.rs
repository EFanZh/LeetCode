...
mod tests {
    ...
    type TestCase<'a> = ((&'a [Option<i32>], &'a [i32]), &'a [i32]);
    ...
    const EXTRA_TEST_CASE: TestCase = (
        (
            ...
            &[
                15, 40, 6, 21, 9, 19, 2, 12, 50, 47, 35, 28, 20, 5, 4, 10, 32, 3, 14, 44, 29, 18, 34, 7, 11, 43, 41,
                27, 42, 37, 23, 26, 38, 16, 45, 24, 13, 36, 49, 8, 22, 33, 25, 1, 46, 48, 31, 39, 17, 30,
            ],
        ),
        &[-1],
    );
