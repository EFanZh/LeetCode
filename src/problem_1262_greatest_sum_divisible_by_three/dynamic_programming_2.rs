                        ...
                        loop {
                            if let Some(num) = iter.next() {
                                match num % 3 {
                                    ...
                                    1 => break 'outer (max_1.max(max_0 + num), max_1 + num),
                                    _ => {
                                        let max_2 = max_0 + num;

                                        max_0 = max_0.max(max_1 + num);

                                        break 'outer (max_1, max_2);
                                    }
                                }
                            } else {
                                return max_0 as _;
                        ...
                        loop {
                            if let Some(num) = iter.next() {
                                match num % 3 {
                                    ...
                                    _ => break 'outer (max_2 + num, max_2.max(max_0 + num)),
                                }
                            } else {
                                return max_0 as _;
                            }
